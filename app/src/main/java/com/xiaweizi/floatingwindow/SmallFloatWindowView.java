 ...
 * <pre>
 *     author : xiaweizi
 *     class  : com.xiaweizi.floatingwindow.SmallFloatWindowView
...
public class SmallFloatWindowView extends LinearLayout {
    ...
    private void init(Context context) {
        CircleView view = new CircleView(getContext(), mDipScale);
        LinearLayout.LayoutParams layoutParams = new LayoutParams((int) (viewSize * mDipScale), (int) (viewSize * mDipScale));
